...
public class DBConfiguration {
	...
	// Change the below based on the DBMS you choose jdbc:oracle:thin:bhanoo@localhost:1521/xe
		private final static String DATABASE_URL = "jdbc:oracle:thin:bhanoo@//localhost:1521/xe";
		...
		private final static String DATABASE_USERNAME = "bhanoo";
